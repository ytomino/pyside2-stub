...
class QBitmap(PySide2.QtGui.QPixmap):
    ...
    @staticmethod
    def fromImage(image: PySide2.QtGui.QImage, flags: PySide2.QtCore.Qt.ImageConversionFlags = ...) -> typing.Union[PySide2.QtGui.QPixmap, PySide2.QtGui.QBitmap]: ...
    @typing.overload
    ...
    @typing.overload
    def transformed(self, matrix: PySide2.QtGui.QTransform, mode: PySide2.QtCore.Qt.TransformationMode = ...) -> PySide2.QtGui.QPixmap: ...
...
class QImageReader(object):
    ...
    @typing.overload
#   @classmethod
    def imageFormat(self, device: PySide2.QtCore.QIODevice) -> PySide2.QtCore.QByteArray: ...
    @typing.overload
#   @classmethod
    def imageFormat(self, fileName: str) -> PySide2.QtCore.QByteArray: ...
    @typing.overload
...
class QMatrix(object):
    ...
    def __imul__(self, l: PySide2.QtCore.QLine) -> PySide2.QtCore.QLine: ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, l: PySide2.QtCore.QLineF) -> PySide2.QtCore.QLineF: ...
    @typing.overload
    def __imul__(self, arg__1: PySide2.QtGui.QMatrix) -> PySide2.QtGui.QMatrix: ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, p: PySide2.QtCore.QPoint) -> PySide2.QtCore.QPoint: ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, p: PySide2.QtCore.QPointF) -> PySide2.QtCore.QPointF: ...
    def __lshift__(self, arg__1: PySide2.QtCore.QDataStream) -> PySide2.QtCore.QDataStream: ...
    @typing.overload
...
class QMatrix2x2(object):
    ...
    @typing.overload
    def __init__(self, arg__1: typing.Iterable[typing.Any]) -> None: ...
...
#   def __reduce__(self) -> typing.Union[str, Tuple[typing.Any, ...]]: ...
#   def __repr__(self) -> str: ...
    def data(self) -> tuple[float, float, float, float, float, float]: ...
    def fill(self, value: float) -> None: ...
    def isIdentity(self) -> bool: ...
    def setToIdentity(self) -> None: ...
...
#   def __reduce__(self) -> typing.Union[str, Tuple[typing.Any, ...]]: ...
#   def __repr__(self) -> str: ...
    def data(self) -> tuple[float, float, float, float, float, float, float, float]: ...
    def fill(self, value: float) -> None: ...
    def isIdentity(self) -> bool: ...
    def setToIdentity(self) -> None: ...
...
#   def __reduce__(self) -> typing.Union[str, Tuple[typing.Any, ...]]: ...
#   def __repr__(self) -> str: ...
    def data(self) -> tuple[float, float, float, float, float, float, float, float, float]: ...
    def fill(self, value: float) -> None: ...
    def isIdentity(self) -> bool: ...
    def setToIdentity(self) -> None: ...
...
#   def __reduce__(self) -> typing.Union[str, Tuple[typing.Any, ...]]: ...
#   def __repr__(self) -> str: ...
    def data(self) -> tuple[float, float, float, float, float, float, float, float, float, float, float, float]: ...
    def fill(self, value: float) -> None: ...
    def isIdentity(self) -> bool: ...
    def setToIdentity(self) -> None: ...
...
class QMatrix4x4(object):
    ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, point: PySide2.QtCore.QPoint) -> PySide2.QtCore.QPoint: ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, point: PySide2.QtCore.QPointF) -> PySide2.QtCore.QPointF: ...
...
#   def __repr__(self) -> str: ...
    ...
    def data(self) -> tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]: ...
    def determinant(self) -> float: ...
    def fill(self, value: float) -> None: ...
...
class QOpenGLBuffer(object):
    ...
    @typing.overload
#   @classmethod
    def release(self, type: PySide2.QtGui.QOpenGLBuffer.Type) -> None: ...
...
class QOpenGLShaderProgram(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setUniformValue(self, location: int, value: typing.Union[int, float]) -> None: ...
    @typing.overload
...
class QOpenGLTexture(object):
    ...
    @typing.overload
    def setBorderColor(self, r: typing.Union[int, float], g: typing.Union[int, float], b: typing.Union[int, float], a: typing.Union[int, float]) -> None: ...
...
class QPageSize(object):
    ...
    @typing.overload
#   @classmethod
    def definitionSize(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> PySide2.QtCore.QSizeF: ...
    @typing.overload
    def definitionSize(self) -> PySide2.QtCore.QSizeF: ...
    @typing.overload
#   @classmethod
    def definitionUnits(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> PySide2.QtGui.QPageSize.Unit: ...
    @typing.overload
    def definitionUnits(self) -> PySide2.QtGui.QPageSize.Unit: ...
    @typing.overload
#   @classmethod
    def id(self, pointSize: PySide2.QtCore.QSize, matchPolicy: PySide2.QtGui.QPageSize.SizeMatchPolicy = ...) -> PySide2.QtGui.QPageSize.PageSizeId: ...
    @typing.overload
    def id(self) -> PySide2.QtGui.QPageSize.PageSizeId: ...
    @typing.overload
#   @classmethod
    def id(self, size: PySide2.QtCore.QSizeF, units: PySide2.QtGui.QPageSize.Unit, matchPolicy: PySide2.QtGui.QPageSize.SizeMatchPolicy = ...) -> PySide2.QtGui.QPageSize.PageSizeId: ...
    @typing.overload
#   @classmethod
    def id(self, windowsId: int) -> PySide2.QtGui.QPageSize.PageSizeId: ...
    def isEquivalentTo(self, other: PySide2.QtGui.QPageSize) -> bool: ...
    def isValid(self) -> bool: ...
    @typing.overload
#   @classmethod
    def key(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> str: ...
    @typing.overload
    def key(self) -> str: ...
    @typing.overload
#   @classmethod
    def name(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> str: ...
    @typing.overload
    def name(self) -> str: ...
    ...
    @typing.overload
#   @classmethod
    def size(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId, units: PySide2.QtGui.QPageSize.Unit) -> PySide2.QtCore.QSizeF: ...
    @typing.overload
    def size(self, units: PySide2.QtGui.QPageSize.Unit) -> PySide2.QtCore.QSizeF: ...
    @typing.overload
#   @classmethod
    def sizePixels(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId, resolution: int) -> PySide2.QtCore.QSize: ...
    @typing.overload
    def sizePixels(self, resolution: int) -> PySide2.QtCore.QSize: ...
    @typing.overload
#   @classmethod
    def sizePoints(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> PySide2.QtCore.QSize: ...
    @typing.overload
    def sizePoints(self) -> PySide2.QtCore.QSize: ...
    def swap(self, other: PySide2.QtGui.QPageSize) -> None: ...
    @typing.overload
#   @classmethod
    def windowsId(self, pageSizeId: PySide2.QtGui.QPageSize.PageSizeId) -> int: ...
    @typing.overload
...
class QPixmapCache(object):
    ...
    @typing.overload
#   @classmethod
    def find(self, key: PySide2.QtGui.QPixmapCache.Key, pixmap: PySide2.QtGui.QPixmap) -> bool: ...
    @typing.overload
#   @classmethod
    def find(self, key: str) -> PySide2.QtGui.QPixmap: ...
    @typing.overload
#   @classmethod
    def find(self, key: str, pixmap: PySide2.QtGui.QPixmap) -> bool: ...
    @typing.overload
...
class QSyntaxHighlighter(PySide2.QtCore.QObject):
    ...
    def __init__(self, parent: typing.Union[PySide2.QtCore.QObject, PySide2.QtGui.QTextDocument]) -> None: ...
...
class QTextList(PySide2.QtGui.QTextBlockGroup):
    ...
    def setFormat(self, format: typing.Union[PySide2.QtGui.QTextFormat, PySide2.QtGui.QTextListFormat]) -> None: ...
...
class QTextTable(PySide2.QtGui.QTextFrame):
    ...
    def rows(self) -> int: ...
    def setFormat(self, format: typing.Union[PySide2.QtGui.QTextFormat, PySide2.QtGui.QTextTableFormat]) -> None: ...
...
class QVector3D(object):
    ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, matrix: PySide2.QtGui.QMatrix4x4) -> PySide2.QtGui.QVector3D: ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, quaternion: PySide2.QtGui.QQuaternion) -> PySide2.QtGui.QVector3D: ...
    @typing.overload
...
class QVector4D(object):
    ...
    @typing.overload
    @typing.type_check_only
    def __imul__(self, matrix: PySide2.QtGui.QMatrix4x4) -> PySide2.QtGui.QVector4D: ...
    @typing.overload
...
class QWindow(PySide2.QtCore.QObject, PySide2.QtGui.QSurface):
    ...
    def setParent(self, parent: typing.Union[PySide2.QtCore.QObject, PySide2.QtGui.QWindow]) -> None: ...
    @typing.overload
