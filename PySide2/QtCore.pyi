...
class ClassInfo(object):
    ...
    @staticmethod
    def __init__(**info: typing.Dict[str, str]) -> None: ...
...
class Property(object):
    ...
    def __init__(self, type: type, fget: typing.Optional[typing.Callable] = ..., fset: typing.Optional[typing.Callable] = ..., freset: typing.Optional[typing.Callable] = ..., fdel: typing.Optional[typing.Callable] = ..., doc: str = ..., notify: typing.Optional[typing.Callable] = ..., designable: bool = ..., scriptable: bool = ..., stored: bool = ..., user: bool = ..., constant: bool = ..., final: bool = ...) -> None: ...
...
class QByteArray(object):
    ...
    def __iadd__(self, arg__1: bytes) -> PySide2.QtCore.QByteArray: ...
...
class QCborStreamReader(object):
    ...
    @typing.overload
    def __init__(self, data: typing.Union[bytes, bytearray], len: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def addData(self, data: typing.Union[bytes, bytearray], len: int) -> None: ...
    def clear(self) -> None: ...
...
class QCborValue(object):
    ...
    @typing.overload
    @staticmethod
    def fromCbor(data: typing.Union[bytes, bytearray], len: int, error: typing.Optional[PySide2.QtCore.QCborParserError] = ...) -> PySide2.QtCore.QCborValue: ...
    @typing.overload
    @staticmethod
...
#   def __repr__(self) -> str: ...
    ...
    @typing.overload
#   @classmethod
    def isValid(self, y: int, m: int, d: int) -> bool: ...
    @staticmethod
...
class QFile(PySide2.QtCore.QFileDevice):
    ...
    @typing.overload
#   @classmethod
    def copy(self, fileName: str, newName: str) -> bool: ...
    @typing.overload
...
#   @classmethod
    ...
    @typing.overload
#   @classmethod
    def link(self, oldname: str, newName: str) -> bool: ...
    @typing.overload
    def link(self, newName: str) -> bool: ...
    @typing.overload
#   @classmethod
    def moveToTrash(self, fileName: str) -> typing.Tuple[bool, str]: ...
    @typing.overload
    ...
    @typing.overload
#   @classmethod
    def permissions(self, filename: str) -> PySide2.QtCore.QFileDevice.Permissions: ...
    @typing.overload
    def permissions(self) -> PySide2.QtCore.QFileDevice.Permissions: ...
    @typing.overload
#   @classmethod
    def readLink(self, fileName: str) -> str: ...
    @typing.overload
...
#   @classmethod
    ...
    @typing.overload
#   @classmethod
    def resize(self, filename: str, sz: int) -> bool: ...
    @typing.overload
    def resize(self, sz: int) -> bool: ...
    def setFileName(self, name: str) -> None: ...
    @typing.overload
#   @classmethod
    def setPermissions(self, filename: str, permissionSpec: PySide2.QtCore.QFileDevice.Permissions) -> bool: ...
    @typing.overload
    def setPermissions(self, permissionSpec: PySide2.QtCore.QFileDevice.Permissions) -> bool: ...
    def size(self) -> int: ...
    @typing.overload
#   @classmethod
    def symLinkTarget(self, fileName: str) -> str: ...
    @typing.overload
...
class QJsonValue(object):
    ...
    @typing.overload
    def __init__(self, n: typing.Union[int, float]) -> None: ...
    @typing.overload
...
class QLocale(object):
    ...
    @typing.overload
    def toCurrencyString(self, arg__1: typing.Union[int, float], symbol: str = ...) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def toString(self, i: typing.Union[int, float], f: int = ..., prec: int = ...) -> str: ...
    @typing.overload
...
class QObject(object):
    ...
    @typing.overload
#   @classmethod
    def connect(self, arg__1: PySide2.QtCore.QObject, arg__2: bytes, arg__3: typing.Callable, type: PySide2.QtCore.Qt.ConnectionType = ...) -> bool: ...
    @typing.overload
    ...
    @typing.overload
#   @classmethod
    def connect(self, sender: PySide2.QtCore.QObject, signal: PySide2.QtCore.QMetaMethod, receiver: PySide2.QtCore.QObject, method: PySide2.QtCore.QMetaMethod, type: PySide2.QtCore.Qt.ConnectionType = ...) -> PySide2.QtCore.QMetaObject.Connection: ...
    @typing.overload
#   @classmethod
    def connect(self, sender: PySide2.QtCore.QObject, signal: bytes, receiver: PySide2.QtCore.QObject, member: bytes, type: PySide2.QtCore.Qt.ConnectionType = ...) -> PySide2.QtCore.QMetaObject.Connection: ...
    def connectNotify(self, signal: PySide2.QtCore.QMetaMethod) -> None: ...
    def customEvent(self, event: PySide2.QtCore.QEvent) -> None: ...
    def deleteLater(self) -> None: ...
    @typing.overload
#   @classmethod
    def disconnect(self, arg__1: PySide2.QtCore.QMetaObject.Connection) -> bool: ...
    @typing.overload
#   @classmethod
    def disconnect(self, arg__1: PySide2.QtCore.QObject, arg__2: bytes, arg__3: typing.Callable) -> bool: ...
    @typing.overload
    ...
    @typing.overload
#   @classmethod
    def disconnect(self, sender: PySide2.QtCore.QObject, signal: PySide2.QtCore.QMetaMethod, receiver: PySide2.QtCore.QObject, member: PySide2.QtCore.QMetaMethod) -> bool: ...
    @typing.overload
#   @classmethod
    def disconnect(self, sender: PySide2.QtCore.QObject, signal: bytes, receiver: PySide2.QtCore.QObject, member: bytes) -> bool: ...
    ...
    @typing.overload
    def findChildren(self, arg__1: typing.Type[T], arg__2: PySide2.QtCore.QRegExp) -> typing.Iterable[T]: ...
    @typing.overload
    def findChildren(self, arg__1: typing.Type[T], arg__2: PySide2.QtCore.QRegularExpression) -> typing.Iterable[T]: ...
    @typing.overload
    def findChildren(self, arg__1: typing.Type[T], arg__2: str = ...) -> typing.Iterable[T]: ...
...
class QPoint(object):
    ...
    def __imul__(self, factor: typing.Union[int, float]) -> PySide2.QtCore.QPoint: ...
    def __isub__(self, p: PySide2.QtCore.QPoint) -> PySide2.QtCore.QPoint: ...
    def __mul__(self, factor: typing.Union[int, float]) -> PySide2.QtCore.QPoint: ...
...
class QProcess(PySide2.QtCore.QIODevice):
    ...
    @typing.overload
#   @classmethod
    def startDetached(self, command: str) -> bool: ...
    @typing.overload
#   @classmethod
    def startDetached(self, program: str, arguments: typing.Sequence[str]) -> bool: ...
    @typing.overload
#   @classmethod
    def startDetached(self, program: str, arguments: typing.Sequence[str], workingDirectory: str) -> typing.Tuple[bool, int]: ...
    @typing.overload
...
class QRandomGenerator(object):
    ...
    @typing.overload
    def bounded(self, highest: typing.Union[int, float]) -> float: ...
    @typing.overload
...
class QSignalTransition(PySide2.QtCore.QAbstractTransition):
    ...
    @typing.overload
    def __init__(self, arg__1: object, arg__2: typing.Optional[PySide2.QtCore.QState] = ...) -> None: ...
    @typing.overload
...
class QSizeF(object):
    ...
    def __isub__(self, arg__1: typing.Union[PySide2.QtCore.QSize, PySide2.QtCore.QSizeF]) -> PySide2.QtCore.QSizeF: ...
    def __mul__(self, c: float) -> PySide2.QtCore.QSizeF: ...
#   def __reduce__(self) -> typing.Union[str, Tuple[typing.Any, ...]]: ...
#   def __repr__(self) -> str: ...
    def __sub__(self, s2: typing.Union[PySide2.QtCore.QSize, PySide2.QtCore.QSizeF]) -> PySide2.QtCore.QSizeF: ...
...
class QStateMachine(PySide2.QtCore.QState):
    ...
    def configuration(self) -> typing.Union[typing.Set[PySide2.QtCore.QAbstractState], typing.List[PySide2.QtCore.QAbstractState]]: ...
...
class QTextStream(object):
    ...
    @typing.overload
    def __lshift__(self, ch: typing.Union[int, str]) -> PySide2.QtCore.QTextStream: ...
    @typing.overload
    def __lshift__(self, f: typing.Union[int, float]) -> PySide2.QtCore.QTextStream: ...
#   @typing.overload
...
#   def __repr__(self) -> str: ...
    ...
    @typing.overload
#   @classmethod
    def isValid(self, h: int, m: int, s: int, ms: int = ...) -> bool: ...
    @typing.overload
    def isValid(self) -> bool: ...
    def minute(self) -> int: ...
    def msec(self) -> int: ...
...
class Qt(object):
    ...
    class CursorShape(object):
        ArrowCursor              : typing.ClassVar[Qt.CursorShape] = ... # 0x0
        UpArrowCursor            : typing.ClassVar[Qt.CursorShape] = ... # 0x1
        CrossCursor              : typing.ClassVar[Qt.CursorShape] = ... # 0x2
        WaitCursor               : typing.ClassVar[Qt.CursorShape] = ... # 0x3
        IBeamCursor              : typing.ClassVar[Qt.CursorShape] = ... # 0x4
        SizeVerCursor            : typing.ClassVar[Qt.CursorShape] = ... # 0x5
        SizeHorCursor            : typing.ClassVar[Qt.CursorShape] = ... # 0x6
        SizeBDiagCursor          : typing.ClassVar[Qt.CursorShape] = ... # 0x7
        SizeFDiagCursor          : typing.ClassVar[Qt.CursorShape] = ... # 0x8
        SizeAllCursor            : typing.ClassVar[Qt.CursorShape] = ... # 0x9
        BlankCursor              : typing.ClassVar[Qt.CursorShape] = ... # 0xa
        SplitVCursor             : typing.ClassVar[Qt.CursorShape] = ... # 0xb
        SplitHCursor             : typing.ClassVar[Qt.CursorShape] = ... # 0xc
        PointingHandCursor       : typing.ClassVar[Qt.CursorShape] = ... # 0xd
        ForbiddenCursor          : typing.ClassVar[Qt.CursorShape] = ... # 0xe
        WhatsThisCursor          : typing.ClassVar[Qt.CursorShape] = ... # 0xf
        BusyCursor               : typing.ClassVar[Qt.CursorShape] = ... # 0x10
        OpenHandCursor           : typing.ClassVar[Qt.CursorShape] = ... # 0x11
        ClosedHandCursor         : typing.ClassVar[Qt.CursorShape] = ... # 0x12
        DragCopyCursor           : typing.ClassVar[Qt.CursorShape] = ... # 0x13
        DragMoveCursor           : typing.ClassVar[Qt.CursorShape] = ... # 0x14
        DragLinkCursor           : typing.ClassVar[Qt.CursorShape] = ... # 0x15
        LastCursor               : typing.ClassVar[Qt.CursorShape] = ... # 0x15
        BitmapCursor             : typing.ClassVar[Qt.CursorShape] = ... # 0x18
        CustomCursor             : typing.ClassVar[Qt.CursorShape] = ... # 0x19
...
class SignalInstance(object):
    ...
    @staticmethod
    def disconnect(slot: typing.Optional[object] = ...) -> None: ...
    @staticmethod
    def emit(*args: typing.Any) -> None: ...


DECORATED = typing.TypeVar('DECORATED', bound=typing.Callable)
class Slot(object):

    @staticmethod
    def __init__(*types: type, name: typing.Optional[str] = ..., result: typing.Optional[type] = ...) -> None: ...

    def __call__(self, arg__1: DECORATED) -> DECORATED: ...
